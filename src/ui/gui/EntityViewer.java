...
public class EntityViewer extends JPanel {
    ...
    private void initializePlayerInfo() {
        ...
        lblName.setFont(new Font("Lucida Grande", Font.BOLD, 17));
        ...
        lblDay.setFont(new Font("Lucida Grande", Font.BOLD, 17));
